        ...
        <>
          ...
          <br/>
           ...
           <br/><br/>
            ...
            <label>Name:
              <input type="text" onChange={e => setCatName(e.target.value)}></input></label><br />
            <label>comment:
              <input type="text" onChange={e => setCatComment(e.target.value)}></input></label><br />
            <label>vote: </label>
            ...
            <label>Name:
              <input type="text" onChange={e => setDogName(e.target.value)}></input></label><br />
            <label>comment:
              <input type="text" onChange={e => setDogComment(e.target.value)}></input></label><br />
            <label>vote: </label>
            <input type="number" placeholder='from 1-10' onChange={e => setDogVote(e.target.value)}></input><br />
          </form><br />
